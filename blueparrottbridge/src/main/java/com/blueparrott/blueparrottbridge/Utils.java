...
/*
 * Utilities methods for BP Connect
 */
public class Utils {
    ...
    */
    ...
    public static Notification buildNotification(Context context, int state) {
        ...
        mBuilder.setContentTitle("BlueParrott Button")
    ...
    /**
     * Create a notification based on the current  state
     */
    ...
    protected static String getConnectErrorDescription(int errorCode) {
        switch (errorCode) {
            ...
            case BPHeadsetListener.CONNECT_ERROR_WORK_PROFILE_COULD_NOT_CONNECT:
                return "Android Work Profile Bug Detected - Button events will still be triggered";
            default:
                return "Unknown error connecting to Parrott Button "+ errorCode;
        }
